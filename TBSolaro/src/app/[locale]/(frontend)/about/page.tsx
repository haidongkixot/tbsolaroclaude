...
const DEFAULT_TIMELINE: TimelineItem[] = [
  { year: '1992', titleVi: 'Khởi nguồn sản xuất', titleEn: 'Manufacturing Roots', titleEs: 'Raíces de fabricación', descVi: 'Hành trình sản xuất bắt đầu, đặt nền móng cho các giải pháp năng lượng bền vững.', descEn: 'Our manufacturing journey began, laying the groundwork for sustainable energy solutions.', descEs: 'Comenzó nuestro camino de fabricación, sentando las bases para soluciones de energía sostenible.' },
...
const DEFAULT_WHY_US: WhyUsItem[] = [
  { label: 'A', titleVi: 'Chất lượng vượt trội', titleEn: 'Superior Quality', titleEs: 'Calidad superior', descVi: 'Tất cả sản phẩm đạt tiêu chuẩn quốc tế IEC, được kiểm tra nghiêm ngặt tại nhà máy của chúng tôi.', descEn: 'All products meet IEC international standards, rigorously tested in our factory.', descEs: 'Todos los productos cumplen con los estándares internacionales IEC, rigurosamente probados.' },
  ...
  { label: 'C', titleVi: 'Uy tín & Bền vững', titleEn: 'Trust & Sustainability', titleEs: 'Confianza y sostenibilidad', descVi: 'Nhiều thập kỷ kinh nghiệm sản xuất là nền tảng cho cam kết bền vững của TBSolaro.', descEn: 'Decades of manufacturing experience are the foundation for TBSolaro\'s sustainability commitment.', descEs: 'Décadas de experiencia en fabricación son la base del compromiso de sostenibilidad de TBSolaro.' },
];
