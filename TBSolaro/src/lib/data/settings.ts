...
export const siteSettings: SiteSetting[] = [
  ...
  { key: 'site_description', value: 'TBSolaro – Thương hiệu điện năng lượng mặt trời hàng đầu', group: 'general', label: 'Mô tả' },
  ...
  { key: 'footer_copy', value: '© 2025 TBSolaro | All Rights Reserved', group: 'footer', label: 'Copyright text' },
];
