  ...
  const blogs = [
    {
      ...
      excerptEn: 'TBSolaro – The leading solar energy brand by Thai Binh Group.',
      excerptEs: 'TBSolaro – La marca líder de energía solar del Grupo Thai Binh.',
      contentVi: '<p>Năng lượng mặt trời đang trở thành giải pháp thiết yếu trong bối cảnh biến đổi khí hậu toàn cầu. TBSolaro — thương hiệu điện năng lượng mặt trời của Tập đoàn Thái Bình — ra đời với sứ mệnh mang ánh sáng sạch đến mọi mái nhà.</p><p>Với hơn 30 năm kinh nghiệm trong ngành sản xuất, Tập đoàn Thái Bình hiểu rằng phát triển bền vững không chỉ là xu hướng — đó là trách nhiệm. TBSolaro kế thừa tinh thần ấy, cung cấp các giải pháp năng lượng mặt trời toàn diện từ hộ gia đình đến doanh nghiệp, từ Việt Nam đến Cuba.</p><p>Mỗi tấm pin TBSolaro lắp đặt là một bước tiến nhỏ nhưng vững chắc hướng tới tương lai xanh — nơi mái nhà bạn không chỉ che mưa che nắng, mà còn tạo ra năng lượng cho chính cuộc sống của bạn.</p>',
      contentEn: '<p>Solar energy is becoming an essential solution in the context of global climate change. TBSolaro — the solar energy brand of Thai Binh Group — was born with a mission to bring clean light to every rooftop.</p><p>With over 30 years of manufacturing experience, Thai Binh Group understands that sustainable development is not just a trend — it is a responsibility. TBSolaro inherits that spirit, providing comprehensive solar energy solutions from households to businesses, from Vietnam to Cuba.</p><p>Every TBSolaro panel installed is a small but firm step toward a green future — where your roof doesn\'t just shelter you from rain and sun, but also generates energy for your very life.</p>',
      contentEs: '<p>La energía solar se está convirtiendo en una solución esencial en el contexto del cambio climático global. TBSolaro — la marca de energía solar del Grupo Thai Binh — nació con la misión de llevar luz limpia a cada techo.</p><p>Con más de 30 años de experiencia en manufactura, el Grupo Thai Binh entiende que el desarrollo sostenible no es solo una tendencia — es una responsabilidad. TBSolaro hereda ese espíritu, proporcionando soluciones integrales de energía solar desde hogares hasta empresas, desde Vietnam hasta Cuba.</p><p>Cada panel TBSolaro instalado es un paso pequeño pero firme hacia un futuro verde — donde tu techo no solo te protege de la lluvia y el sol, sino que también genera energía para tu propia vida.</p>',
